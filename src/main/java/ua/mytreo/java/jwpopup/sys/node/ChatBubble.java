package ua.mytreo.java.jwpopup.sys.node;

import ua.mytreo.java.jwpopup.dbservice.DBException;
import ua.mytreo.java.jwpopup.dbservice.dataSets.MessagesDataSet;
import ua.mytreo.java.jwpopup.controller.ChatController;
import ua.mytreo.java.jwpopup.controller.MoreController;
...
public class ChatBubble extends Region {
    ...
    private final String resourcePath = "/view/fxml/chatbubble.fxml";
    ...
    public ChatBubble(MessagesDataSet message) {
        ...
        //buttons
        btnDel.setGraphic(new ImageView(ImageHelper.getImageByName("delete")));
        btnMore.setGraphic(new ImageView(ImageHelper.getImageByName("more")));
        btnReply.setGraphic(new ImageView(ImageHelper.getImageByName("reply")));
    }
    ...
    public void btnMoreClick(ActionEvent actionEvent) {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(getClass().getResource("/view/fxml/more.fxml"));
            ...
            moreStage.getIcons().add(ImageHelper.getImageByName("trayicon"));
            moreStage.show();
