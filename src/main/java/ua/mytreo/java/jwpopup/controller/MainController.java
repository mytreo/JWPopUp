...
import ua.mytreo.java.jwpopup.sys.dialog.DateInputDialog;
...
public class MainController implements Initializable {
    ...
    private DataFormat contactDataFormat = new DataFormat("java.ua.mytreo.java.jwpopup.dbservice.dataSets.ContactsDataSet");
    ...
    public void initialize(URL location, ResourceBundle resources) {
        //buttons
        btnAddGroup.setGraphic(new ImageView(ImageHelper.getImageByName("addGroup")));
        btnRemoveMessages.setGraphic(new ImageView(ImageHelper.getImageByName("delmes")));
        btnSettings.setGraphic(new ImageView(ImageHelper.getImageByName("settings")));
                ...
                public void updateItem(Object item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        if (item instanceof GroupsDataSet) {
                            ...
                            try {
                                setGraphic(new ImageView(ImageHelper.getImageByName("arrow")));
                            ...
                            try {
                                setGraphic(new ImageView(ImageHelper.getImageByName("face")));
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                            ...
                            setOnDragDetected((event) -> {
                                ...
                                db.setDragView(ImageHelper.getImageByName("face"));
